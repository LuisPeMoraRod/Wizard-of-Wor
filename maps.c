...
void map2(){
    ...
    x = 120; y = 200;
    wall_right(&x, y, &block, 21);

    x = 230; y = 90;
    wall_down(x, &y, &block, 21);

    x = 330; y = 340;
    wall_right(&x, y, &block, 11);
    wall_up(x, &y, &block, 10);

    x = 440; y = 170;
    wall_up(x, &y, &block, 10);
    wall_left(&x, y, &block, 10);
    
    x = 120; y = 330;
    wall_down(x, &y, &block, 6);
    wall_right(&x, y, &block, 10);
    

    //simetry
    x = 830; y = 200;
    wall_left(&x, y, &block, 21);

    x = 720; y = 90;
    wall_down(x, &y, &block, 21);

    x = 620; y = 340;
    wall_left(&x, y, &block, 11);
    wall_up(x, &y, &block, 10);
